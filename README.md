...
- [done] Open up the [iterative_sorting](src/iterative_sorting) directory
- [done] Read through the descriptions of the `bubble_sort` and `selection_sort` algorithms
- [done] Implement `bubble_sort` and `selection_sort` in [iterative_sorting.py](src/iterative_sorting/iterative_sorting.py)
- [done] Test your implementation by running `test_iterative.py`
- [done] Implement all the methods in the [searching.py](src/searching/searching.py) file in the [searching](src/searching) directory.
- [done] Test your implementation of the searching methods by running `test_searching.py`.
